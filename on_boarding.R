...
data <- read.csv('prj-ML-model-LT_OV30/on_boarding_data_7day.csv', encoding = 'cp949')
head(data)
str(data)
dim(data)
...
df <- subset(data, select = -c(brms_rider_id, first_available_date, business_start_day, recommender_rider_account_id, rider_no, last_working_day, 조회기간))
